...
import { ArrowLeft, Save, Upload, X, ListFilter } from "lucide-react";
import { useCreateCategoryMutation, useGetAllCategories } from "@/hooks/dashboard/categories/useCategories";
    ...
    try {
      ...
      await queryClient.invalidateQueries({ 
        predicate: (query) => {
          ...
          return typeof firstPart === "string" && firstPart.startsWith(CacheKeys.Categories);
        }
      });
    ...
    <div className="flex flex-1 flex-col gap-6 p-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Thêm danh mục mới vào hệ thống</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Nhập thông tin cho danh mục mới</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Ví dụ: Trần thạch cao, Vách ngăn..." {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
